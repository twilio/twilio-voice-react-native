...
class Call extends _eventemitter.EventEmitter {
   ...
   */
  async disconnect() {
    await (0, _nativePromise.settleNativePromise)(_common.NativeModule.call_disconnect(this._uuid));
  }
  /**
  ...
  async getStats() {
    const stats = await (0, _nativePromise.settleNativePromise)(_common.NativeModule.call_getStats(this._uuid));
    return stats;
  }
  /**
  ...
  async hold(hold) {
    this._isOnHold = await (0, _nativePromise.settleNativePromise)(_common.NativeModule.call_hold(this._uuid, hold));
    return this._isOnHold;
  }
  /**
  ...
  async mute(mute) {
    this._isMuted = await (0, _nativePromise.settleNativePromise)(_common.NativeModule.call_mute(this._uuid, mute));
    return this._isMuted;
  }
  /**
   * Send DTMF digits.
  ...
  async sendDigits(digits) {
    await (0, _nativePromise.settleNativePromise)(_common.NativeModule.call_sendDigits(this._uuid, digits));
  }
  /**
   * Send a CallMessage.
   *
  ...
  async sendMessage(message) {
    ...
    const voiceEventSid = await (0, _nativePromise.settleNativePromise)(_common.NativeModule.call_sendMessage(this._uuid, content, contentType, messageType));
  ...
  async postFeedback(score, issue) {
    ...
    await (0, _nativePromise.settleNativePromise)(_common.NativeModule.call_postFeedback(this._uuid, nativeScore, nativeIssue));
  }
