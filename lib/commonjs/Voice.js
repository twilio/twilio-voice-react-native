...
class Voice extends _eventemitter.EventEmitter {
  ...
  async _connect_android(token, params, notificationDisplayName) {
    const callInfo = await (0, _nativePromise.settleNativePromise)(_common.NativeModule.voice_connect_android(token, params, notificationDisplayName));
  ...
  async _connect_ios(token, params, contactHandle) {
    ...
    const callInfo = await (0, _nativePromise.settleNativePromise)(_common.NativeModule.voice_connect_ios(token, params, parsedContactHandle));
    return new _Call.Call(callInfo);
  }
  /**
