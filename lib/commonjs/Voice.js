...
class Voice extends _eventemitter.EventEmitter {
  ...
  constructor() {
    ...
    _defineProperty(this, "_handleCallInviteNotificationTapped", nativeVoiceEvent => {
      if (nativeVoiceEvent.type !== _constants.Constants.VoiceEventCallInviteNotificationTapped) {
    ...
    this._nativeEventHandler = {
      ...
      [_constants.Constants.VoiceEventCallInviteNotificationTapped]: this._handleCallInviteNotificationTapped,
