...
export class Voice extends EventEmitter {
  ...
  constructor() {
    ...
    _defineProperty(this, "_handleCallInviteAccepted", nativeVoiceEvent => {
      ...
      const callInvite = new CallInvite(callInviteInfo, CallInvite.State.Accepted);
      const callInfo = {
    ...
    _defineProperty(this, "_handleCallInviteRejected", nativeVoiceEvent => {
      ...
      const callInvite = new CallInvite(callInviteInfo, CallInvite.State.Rejected);
      this.emit(Voice.Event.CallInviteRejected, callInvite);
    });

    _defineProperty(this, "_handleCallInviteNotificationTapped", nativeVoiceEvent => {
      if (nativeVoiceEvent.type !== Constants.VoiceEventCallInviteNotificationTapped) {
    ...
    _defineProperty(this, "_handleCancelledCallInvite", nativeVoiceEvent => {
      ...
      const cancelledCallInvite = new CancelledCallInvite(cancelledCallInviteInfo);
    ...
    this._nativeEventHandler = {
      ...
      [Constants.VoiceEventCallInviteNotificationTapped]: this._handleCallInviteNotificationTapped,
      [Constants.VoiceEventCallInviteRejected]: this._handleCallInviteRejected,
      [Constants.VoiceEventCallInviteCancelled]: this._handleCancelledCallInvite,
...
(function (_Voice) {
  ...
  (function (Event) {
    ...
    Event["CallInviteNotificationTapped"] = "callInviteNotificationTapped";
