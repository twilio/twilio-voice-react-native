...
export const mockRtcIceCandidateStats = {
  ...
  [Constants.PreflightRTCIceCandidateStatsRelatedAddress]: 'mock-relatedaddress',
...
export const makeMockNativePreflightEvent = eventType => ({
