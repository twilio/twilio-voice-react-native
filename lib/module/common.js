...
export function recordExpoVersion() {
  if (typeof expoVersionPromise === 'undefined') {
    expoVersionPromise = (async () => {
      await settleNativePromise(NativeModule.voice_setExpoVersion(getExpoVersion()));
    })().catch(() => undefined);
  }
