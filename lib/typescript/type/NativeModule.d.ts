...
export interface TwilioVoiceReactNative extends NativeModulesStatic {
    ...
    call_postFeedback(callUuid: Uuid, score: Call.Score, issue: Call.Issue): Promise<void>;
    call_sendDigits(callUuid: Uuid, digits: string): Promise<void>;
    call_sendMessage(callUuid: Uuid, content: string, contentType: CallMessage.ContentType, messageType: CallMessage.MessageType): Promise<string>;
    /**
     ...
     * Voice bindings.
     */
    voice_connect_android(token: string, twimlParams: Record<string, any>): Promise<NativeCallInfo>;
