...
export type NativePromiseNamedRejection = {
    ...
    [Constants.PromiseKeyErrorName]: Constants.ErrorCodeInvalidArgumentError | Constants.ErrorCodeInvalidStateError;
...
export type NativePromise<T> = Promise<NativePromiseResolution<T> | NativePromiseCodedRejection | NativePromiseNamedRejection>;
export interface TwilioVoiceReactNative extends NativeModulesStatic {
    ...
    call_postFeedback(callUuid: Uuid, score: NativeCallFeedbackScore, issue: NativeCallFeedbackIssue): NativePromise<void>;
    call_sendDigits(callUuid: Uuid, digits: string): NativePromise<void>;
    call_sendMessage(callUuid: Uuid, content: string, contentType: string, messageType: string): NativePromise<string>;
    /**
     * Call Invite bindings.
     */
    callInvite_accept(callInviteUuid: Uuid, acceptOptions: CallInvite.AcceptOptions): NativePromise<NativeCallInfo>;
    callInvite_isValid(callInviteUuid: Uuid): NativePromise<boolean>;
    callInvite_reject(callInviteUuid: Uuid): NativePromise<void>;
    callInvite_sendMessage(callInviteUuid: Uuid, content: string, contentType: string, messageType: string): NativePromise<string>;
    callInvite_updateCallerHandle(callInviteUuid: Uuid, handle: string): NativePromise<void>;
    /**
     * Voice bindings.
     */
    voice_connect_android(token: string, twimlParams: Record<string, any>, notificationDisplayName: string | undefined, iceServers: IceServer[] | undefined, iceTransportPolicy: IceTransportPolicy | undefined): NativePromise<NativeCallInfo>;
    voice_connect_ios(token: string, twimlParams: Record<string, any>, contactHandle: string, iceServers: IceServer[] | undefined, iceTransportPolicy: IceTransportPolicy | undefined): NativePromise<NativeCallInfo>;
    ...
    voice_setIncomingCallContactHandleTemplate(template?: string): NativePromise<void>;
     ...
     */
    voice_runPreflight(accessToken: string, options: PreflightTest.Options): NativePromise<Uuid>;
