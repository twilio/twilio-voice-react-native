...
export declare function mockNativePromiseResolutionValue(value: any): {
    promiseKeyStatus: Constants.PromiseStatusValueResolved;
    promiseKeyValue: any;
};
export declare function mockNativePromiseRejectionWithNameValue(name: Constants.ErrorCodeInvalidArgumentError | Constants.ErrorCodeInvalidStateError, message: string): {
    promiseKeyStatus: Constants.PromiseStatusValueRejectedWithName;
    promiseKeyErrorName: Constants.ErrorCodeInvalidStateError | Constants.ErrorCodeInvalidArgumentError;
    promiseKeyErrorMessage: string;
};
export declare function mockNativePromiseRejectionWithCodeValue(code: number, message: string): {
    promiseKeyStatus: Constants.PromiseStatusValueRejectedWithCode;
    promiseKeyErrorCode: number;
    promiseKeyErrorMessage: string;
};
export declare const NativeModule: {
    ...
    call_hold: jest.Mock<Promise<{
        promiseKeyStatus: Constants.PromiseStatusValueResolved;
        promiseKeyValue: any;
    }>, [_uuid: string, hold: boolean]>;
    call_isMuted: jest.Mock<any, any>;
    call_isOnHold: jest.Mock<any, any>;
    call_mute: jest.Mock<Promise<{
        promiseKeyStatus: Constants.PromiseStatusValueResolved;
        promiseKeyValue: any;
    }>, [_uuid: string, mute: boolean]>;
    ...
    callInvite_sendMessage: jest.Mock<any, any>;
    ...
    voice_setExpoVersion: jest.Mock<any, any>;
...
export declare const getExpoVersion: jest.Mock<any, any>;
/**
 ...
 */
export declare const recordExpoVersion: jest.Mock<Promise<void | undefined>, []>;
export {};
