...
static NSString * const kTwilioVoiceReactNativeReactNativeVoiceSDKVer = @"1.0.0-rc24";
...
static NSString * const kTwilioVoiceReactNativeUserDefinedMessage = @"user-defined-message";
static NSString * const kTwilioVoiceReactNativeApplicationJson = @"application/json";
