...
static NSString * const kTwilioVoiceReactNativeReactNativeVoiceSDKVer = @"2.0.0-rc10002";
...
static NSString * const kTwilioVoiceReactNativeAudioDeviceKeyUnknown = @"unknown";
static NSString * const kTwilioVoiceReactNativeAudioDeviceKeyNativeType = @"nativeType";
...
static NSString * const kTwilioVoiceReactNativePromiseKeyStatus = @"promiseKeyStatus";
static NSString * const kTwilioVoiceReactNativePromiseStatusValueRejectedWithCode = @"promiseStatusValueRejectedWithCode";
static NSString * const kTwilioVoiceReactNativePromiseKeyErrorCode = @"promiseKeyErrorCode";
static NSString * const kTwilioVoiceReactNativePromiseStatusValueRejectedWithName = @"promiseStatusValueRejectedWithName";
static NSString * const kTwilioVoiceReactNativePromiseKeyErrorName = @"promiseKeyErrorName";
static NSString * const kTwilioVoiceReactNativePromiseKeyErrorMessage = @"promiseKeyErrorMessage";
static NSString * const kTwilioVoiceReactNativePromiseStatusValueResolved = @"promiseStatusValueResolved";
static NSString * const kTwilioVoiceReactNativePromiseKeyValue = @"promiseKeyValue";
