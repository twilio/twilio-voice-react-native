...
|  --- | --- | --- | --- |
|  [causes](./voice-react-native-sdk.twilioerrors_namespace.authorizationerrors_namespace.rateexceedederror_class.causes_property.md) |  | string\[\] | Message payload size limit exceeded. Rate limit exceeded. |
...
|  [solutions](./voice-react-native-sdk.twilioerrors_namespace.authorizationerrors_namespace.rateexceedederror_class.solutions_property.md) |  | string\[\] | Ensure the message payload does not exceed size limits. Ensure message send rate does not exceed authorized limits. |
