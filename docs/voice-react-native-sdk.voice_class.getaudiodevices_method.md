...
Promise&lt;{ audioDevices: [AudioDevice](./voice-react-native-sdk.audiodevice_class.md)<!-- -->\[\]; selectedDevice: [AudioDevice](./voice-react-native-sdk.audiodevice_class.md) \| null; }&gt;
