...
|  [MessageReceived](./voice-react-native-sdk.call_namespace.listener_namespace.messagereceived_typealias.md) | CallMessage API is in beta.<!-- -->CallMessage received event listener. This should be the function signature of any event listener bound to the [Call.Event.MessageReceived](./voice-react-native-sdk.call_namespace.event_enum.md) event. |
