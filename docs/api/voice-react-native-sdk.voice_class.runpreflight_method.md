...
A Promise that: - Resolves with a [PreflightTest](./voice-react-native-sdk.preflighttest_class.md) object. - Rejects with a `TwilioErrors.TwilioError` if unable to perform a [PreflightTest](./voice-react-native-sdk.preflighttest_class.md)<!-- -->.
