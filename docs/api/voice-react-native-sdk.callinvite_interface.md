...
|  [addListener(messageReceivedEvent, listener)](./voice-react-native-sdk.callinvite_interface.addlistener_4_methodsignature.md) | MessageReceived event. Raised when [CallMessage](./voice-react-native-sdk.callmessage_class.md) is received. |
...
|  [on(messageReceivedEvent, listener)](./voice-react-native-sdk.callinvite_interface.on_4_methodsignature.md) | MessageReceived event. Raised when [CallMessage](./voice-react-native-sdk.callmessage_class.md) is received. |
