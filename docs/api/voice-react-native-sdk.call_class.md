...
|  [sendMessage(message)](./voice-react-native-sdk.call_class.sendmessage_method.md) |  | CallMessage API is in beta.<!-- -->Send [CallMessage](./voice-react-native-sdk.callmessage_class.md)<!-- -->. |
