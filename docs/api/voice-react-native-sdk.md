...
|  [CallMessage](./voice-react-native-sdk.callmessage_class.md) | CallMessage API is in beta.<!-- -->Provides access to information about a callMessage, including the call message content, contentType, messageType, and voiceEventSid |
