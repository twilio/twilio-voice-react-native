...
|  [addListener(messageReceivedEvent, listener)](./voice-react-native-sdk.call_interface.addlistener_7_methodsignature.md) | MessageReceived event. Raised when [CallMessage](./voice-react-native-sdk.callmessage_class.md) is received. |
...
|  [on(callMessageEvent, listener)](./voice-react-native-sdk.call_interface.on_7_methodsignature.md) | MessageReceived event. Raised when [CallMessage](./voice-react-native-sdk.callmessage_class.md) is received. |
