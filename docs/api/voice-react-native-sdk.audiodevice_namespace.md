...
|  --- | --- |
|  [Type](./voice-react-native-sdk.audiodevice_namespace.type_enum.md) | Audio device type enumeration. Describes the well-known audio device types recognized by this SDK. |
