...
|  [UnexpectedNativeError](./voice-react-native-sdk.twilioerrors_namespace.unexpectednativeerror_class.md) | Error describing that the SDK has entered or is attempting to enter an invalid state. |
