...
|  --- | --- | --- |
|  [connect(token, { contactHandle, notificationDisplayName, params, iceServers, iceTransportPolicy, })](./voice-react-native-sdk.voice_class.connect_method.md) |  | Create an outgoing call. |
