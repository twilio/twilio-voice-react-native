...
|  [isFullScreenNotificationEnabled()](./voice-react-native-sdk.voice_class.isfullscreennotificationenabled_method.md) |  | Returns a boolean representing whether or not Android Full Screen notifications are enabled. |
|  [register(token)](./voice-react-native-sdk.voice_class.register_method.md) |  | Register this device for incoming calls. |
|  [requestFullScreenNotificationPermission()](./voice-react-native-sdk.voice_class.requestfullscreennotificationpermission_method.md) |  | Opens the Android System Settings app to attempt to request Full Screen Notification permissions. |
