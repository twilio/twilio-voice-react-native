...
Custom ICE configuration can be provided via the iceServers and iceTransportPolicy options. These options allow specifying custom STUN/TURN servers and transport policy for the call, and behave consistently with the configuration supported by 
